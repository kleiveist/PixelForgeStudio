...
Richtungssets gelten nur für richtungsabhängig bewegliche Assets. Für geeignete bewegliche Assets sind acht Richtungen der Standard: 4 × 2 Frames, Gesamtgröße 512 × 256 Pixel. Reihenfolge: Süd, Südwest, West, Nordwest, Nord, Nordost, Ost, Südost. Statische Objekte, Texturen, Gebäude und gewöhnliche Naturassets erhalten keine Richtungsanforderung. Animation kann unabhängig davon ohne Richtungsset existieren.
