...
export {
  ...
  type ValidatedAnimationFrameTransformDelta,
  type ValidatedAnimationAnchorStatus,
  type ValidatedAnimationPoint,
  type ValidatedAnimationProjectPartDelta,
  type ValidatedAnimationProjectPartLayerOffset,
