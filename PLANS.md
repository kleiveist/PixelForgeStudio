...
| #8 Pipeline | Implemented / pushed; CI/dry run pending | `ba2c5cc`, `bfb4445`; 648 tests, 20 real-container browser smokes; slim runtime removes unused TIFF modules; public-image criteria finalized in #9 |
