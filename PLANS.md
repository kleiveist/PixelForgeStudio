...
Current task: **#9 — final release gate**; #8 corrected SBOM awaits clean CI.
...
| #8 Pipeline | Implemented; corrected SBOM awaits clean CI | `ba2c5cc`, `bfb4445`, `56be779`; 648 app tests + 3 release-tool tests; 20 real-container smokes, both architecture scans and OCI dry run green; complete eight-package SBOM guarded against npm traversal omissions |
